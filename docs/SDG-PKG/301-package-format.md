...
├── CHANGELOG.md       # Version history (auto-generated by sdgbuild)
...
The [SDG-BUILD](https://github.com/SDG-Den/SDG-BUILD) tool (`sdgbuild init`) scaffolds this structure automatically, populating `info.md` from your git remote and providing lifecycle script templates with placeholder variables. `CHANGELOG.md` is auto-generated by `sdgbuild`.
